...
Instale as dependências SCSS, React Router Dom, Lucide React, Typeit e Framer Motion

```bash
  $ npm install scss react-router-dom framer-motion lucide-react typeit-react
```
